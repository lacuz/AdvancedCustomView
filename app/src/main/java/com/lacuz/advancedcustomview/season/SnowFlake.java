...
class SnowFlake {
    ...
    public static SnowFlake create(int width, int height, Paint paint) {
        ...
        float angle = nextFloat(ANGLE_SEED) / ANGLE_SEED * ANGE_RANGE + HALF_PI - HALF_ANGLE_RANGE;
        float increment = nextFloat(INCREMENT_LOWER, INCREMENT_UPPER);
        float flakeSize = nextFloat(FLAKE_SIZE_LOWER, FLAKE_SIZE_UPPER);
    ...
    private void move(int width, int height) {
        ...
        angle += nextFloat(-ANGLE_SEED, ANGLE_SEED) / ANGLE_DIVISOR;
    ...
    private void reset(int width) {
        ...
        angle = nextFloat(ANGLE_SEED) / ANGLE_SEED * ANGE_RANGE + HALF_PI - HALF_ANGLE_RANGE;
    }
    ...
    public static float nextFloat(final float value){
        return value * new Random().nextFloat();
    }
}